...
@Script.Manifest(description = "Plays the mini-game at the Ranged Guild for Ranged XP. Start with lots of bronze arrows equipped at the minigame.", name = "Ranged Guild")
